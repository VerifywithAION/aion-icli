...
if($road.latest_completed_layer -ne 'Sentinel Consistency Engine V1'){ throw 'latest_completed_layer mismatch' }
if($road.next_build_pointer -ne 'Offline AION CLI Bundle V1.1.0'){ throw 'next_build_pointer mismatch' }
...
$mustNext = @('Offline AION CLI Bundle V1')
