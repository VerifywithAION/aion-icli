...
if($road.latest_completed_layer -ne 'Offline AION CLI Bundle V1.1.0'){ throw 'latest_completed_layer mismatch' }
if($road.next_build_pointer -ne 'Public Demo: Agent Claim vs AION Proof Gate V1'){ throw 'next_build_pointer mismatch' }
