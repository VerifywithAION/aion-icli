...
if($road.latest_completed_layer -ne 'Public Demo Fresh Clone Acceptance V1'){ throw 'latest_completed_layer mismatch' }
if($road.next_build_pointer -ne 'Public Release Notes v1.1.0 Demo Package V1'){ throw 'next_build_pointer mismatch' }
