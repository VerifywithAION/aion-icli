...
if($road.latest_completed_layer -ne 'Introspection Gate V1'){ throw 'latest_completed_layer mismatch' }
if($road.next_build_pointer -ne 'Contradiction Engine V1'){ throw 'next_build_pointer mismatch' }
...
$layers = @($wire.layers)
$requiredLayers = @('Public Safe Verifier','Public Install Package V1','User Guide V1','Interactive Mode V1','Capability Router V1','Voice Layer V1','Adaptive Reasoning Layer V1','Governance Brain Adapter V1','Governance Brain Integration Fix V1','Memory Scar Engine V1','Artifact Inspection Runner V1','Living Proof Graph V1','Evidence Engine V1','Introspection Gate V1')
...
$mustNext = @('Contradiction Engine V1','Self-Repair Planner V1','Sentinel Consistency Engine V1','Offline AION CLI Bundle V1')
