...
if($road.latest_completed_layer -ne 'Self-Repair Planner V1'){ throw 'latest_completed_layer mismatch' }
if($road.next_build_pointer -ne 'Sentinel Consistency Engine V1'){ throw 'next_build_pointer mismatch' }
...
$mustNext = @('Sentinel Consistency Engine V1','Offline AION CLI Bundle V1')
